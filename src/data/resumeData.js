...
export const projects = [
  ...
  },
  {
    ...
    features: [
      ...
      "Conducted competitive analysis and positioning strategy for decentralized hosting offerings."
    ],
    link: "https://tomi.com/storage"
  },
  {
    name: "BlockDAG",
    description: "DAG based blockchain | Mining Mobile Application",
    features: [
      "Reworked onboarding and mining UX flows, contributing to a ~35% increase in app downloads after v2 release."
    ],
...
export const portfolioItems = [
  ...
  {
    title: "Vine Labs",
    description: "Layer 0 interoperable ecosystem | Metaverse. Built modular cross-chain functionality for metaverse applications, enabling platform scalability.",
    techStack: ["Layer 0", "Metaverse", "Cross-chain"],
    link: "https://www.vinelayer0.com/"
  }
];
...
export const certifications = [
  ...
  {
    name: "Certified Business Analysis Professional (CCBA)",
    issuer: "IIBA",
  ...
  {
    name: "Blockchain Development & Product Planning",
    issuer: "Coursera",
    tag: "Blockchain"
  },
  {
